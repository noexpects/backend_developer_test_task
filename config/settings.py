...
env = environ.Env(
    ...
    PRODUCT_PICTURES_FOLDER=(str, 'product_pictures/'),
    PRODUCT_LIST_PAGINATE_BY=(int, 5),
)
...
PRODUCT_PICTURES_FOLDER = env('PRODUCT_PICTURES_FOLDER')

PRODUCT_LIST_PAGINATE_BY = env('PRODUCT_LIST_PAGINATE_BY')
